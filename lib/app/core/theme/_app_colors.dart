...
abstract class AcnooAppColors {
  ...
  static final kSuccess20Op = kSuccess.withValues(alpha: 0.20);
  //---------------Success Colors---------------//

  //---------------Info Colors---------------//
  static const kInfo = Color(0xff1D4ED8);
  static final kInfo20Op = kInfo.withValues(alpha: 0.20);
  //---------------Info Colors---------------//

  //---------------Warning Colors---------------//
  static const kWarning = Color(0xffFD7F0B);
  static final kWarning20Op = kWarning.withValues(alpha: 0.20);
  //---------------Warning Colors---------------//

  //---------------Error Colors---------------//
  static const kError = Color(0xffE40F0F);
  static final kError20Op = kError.withValues(alpha: 0.20);
  //---------------Error Colors---------------//

  //---------------Processing Color------------------
  static const kProcessingColor = Color(0xff2400FF);
  //---------------Processing Color------------------
  ...
  //---------------Partial Color---------------//
  static const kPartialColor = Color(0xffAF52DE);
  //---------------Partial Color---------------//
}
