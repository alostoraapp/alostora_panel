                        ...
                        child: Row(
                          ...
                          children: [
                            _buildOverviewBase(
                              ...
                              gradientColor: [
                                const Color(0xff0F77EB).withValues(alpha: 0.10),
                                const Color(0xff12C0FF).withValues(alpha: 0.10),
                              ],
                            ),
                            ...
                            _buildOverviewBase(
                              ...
                              gradientColor: [
                                const Color(0xffFEB36D).withValues(alpha: 0.10),
                                const Color(0xffFD800E).withValues(alpha: 0.10),
                              ],
                            ),
                          ],
                        ),
