...
class SalaryReportLineChart extends StatelessWidget {
  const SalaryReportLineChart({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    const _totalColor = Color(0xff7500FD);
    const _thisMonthColor = Color(0xffF0483F);
            ...
            Text.rich(
              TextSpan(
                children: [
                  const TextSpan(
                    text: '● ',
                    style: TextStyle(color: _totalColor),
                  ),
                  TextSpan(
                    // text: "Total: ",
                    text: "${lang.total}: ",
            ...
            Text.rich(
              TextSpan(
                children: [
                  const TextSpan(
                    text: '● ',
                    style: TextStyle(color: _thisMonthColor),
                  ),
                  TextSpan(
                    //text: "This Month: ",
                    text: "${lang.thisMonth}: ",
                    ...
                    return touchedSpots.map((item) {
                      ...
                      return LineTooltipItem(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text:
                                "${item.barIndex == 0 ? lang.total : lang.thisMonth}:",
                            style: TextStyle(
                              color: _isDark
                                  ? _theme.colorScheme.onPrimaryContainer
                                  : const Color(0xff667085),
                ...
                LineChartBarData(
                  ...
                  belowBarData: BarAreaData(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        _totalColor.withValues(alpha: 0.075),
                        Colors.white,
                      ],
                    ),
                  ),
                ...
                LineChartBarData(
                  ...
                  belowBarData: BarAreaData(
                    ...
                    gradient: LinearGradient(
                      ...
                      tileMode: TileMode.decal,
                      colors: [
                        _thisMonthColor.withValues(alpha: 0.15),
                        Colors.white,
                      ],
                    ),
                  ),
