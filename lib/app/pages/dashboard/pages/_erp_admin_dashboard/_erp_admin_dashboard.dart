                ...
                ResponsiveGridCol(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ShadowContainer(
                      ...
                      headerBackgroundColor: const Color(0xffFFE3ED).withValues(
                        alpha: _isDark ? 0.15 : 0.20,
                      ),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ShadowContainer(
                      ...
                      headerBackgroundColor: const Color(0xffF8FFE0)
                          .withValues(alpha: _isDark ? 0.15 : 1),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ShadowContainer(
                      ...
                      headerBackgroundColor:
                          const Color(0xffAF49FF).withValues(alpha: 0.10),
                      trailing: FilterDropdownButton(
                        items: List.generate(
                          5,
                          (i) => DropdownMenuItem(
...
List<OverviewItem> get _overviewItems => <OverviewItem>[
      ...[
        ...
        (item) => OverviewItem(
          ...
          value: item.$2,
          subtitle: item.$3,
          iconColor: item.$4.withValues(alpha: 0.15),
        ),
      )
    ];
