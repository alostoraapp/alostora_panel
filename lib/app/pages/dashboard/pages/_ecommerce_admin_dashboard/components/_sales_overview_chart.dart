...
class _OverviewTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _darkGradientColors = [
      const Color(0xffF9F3FF).withValues(alpha: 0.04),
      const Color(0xff8FFFB9).withValues(alpha: 0.25),
      const Color(0xffC696FF).withValues(alpha: 0.25),
      const Color(0xffFFCC9D).withValues(alpha: 0.25),
      const Color(0xffF9F3FF).withValues(alpha: 0.04),
    ];
