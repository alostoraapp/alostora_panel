...
class CryptoDataModel {
  ...
  @override
  String toString() =>
      'CryptoDataModel(coinName: $coinName, shortName: $shortName, price: $price, statusPercentage: $statusPercentage, imagePath: $imagePath)';
}
  ...
  static List<CryptoDataModel> get cryptoList => [
        CryptoDataModel(
          ...
          chartColor: LinearGradient(
            colors: [
              ...
              const Color(0xffF98C08).withValues(alpha: 0.66),
              const Color(0xffF98C08).withValues(alpha: 0),
            ],
          ),
        ...
        CryptoDataModel(
          ...
          chartColor: LinearGradient(colors: [
            const Color(0xffC817F8).withValues(alpha: 0.39),
            const Color(0xffC817F8).withValues(alpha: 0),
          ]),
          percentageColor: const Color(0xff45B369),
        ),
        CryptoDataModel(
          ...
          chartColor: LinearGradient(colors: [
            ...
            const Color(0xff5F80FF).withValues(alpha: 0.66),
            const Color(0xff5F80FF).withValues(alpha: 0),
          ]),
        ...
        CryptoDataModel(
          ...
          chartColor: LinearGradient(colors: [
            ...
            const Color(0xFF7500FD).withValues(alpha: 0),
          ]),
        ),
      ];
}
