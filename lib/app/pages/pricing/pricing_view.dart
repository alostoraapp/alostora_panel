...
class ArrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Stroke.color = const Color(0xff7500FD).withValues(alpha: 1.0);
    paint0Stroke.strokeCap = StrokeCap.round;
    canvas.drawPath(path0, paint0Stroke);
    ...
    Paint paint1Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.02803738;
    paint1Stroke.color = const Color(0xff7500FD).withValues(alpha: 1.0);
    ...
    Paint paint2Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.02803738;
    paint2Stroke.color = const Color(0xff7500FD).withValues(alpha: 1.0);
    paint2Stroke.strokeCap = StrokeCap.round;
    canvas.drawPath(path2, paint2Stroke);

    Paint paint2Fill = Paint()..style = PaintingStyle.fill;
    paint2Fill.color = const Color(0xff000000).withValues(alpha: 1.0);
