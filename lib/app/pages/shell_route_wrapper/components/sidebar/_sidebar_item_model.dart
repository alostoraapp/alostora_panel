  ...
  return <SidebarItemModel>[
    SidebarItemModel(
      ...
      submenus: [
        ...
        SidebarSubmenuModel(
          name: l.S.current.schoolManagement,
          navigationPath: 'school-management',
        ),
        SidebarSubmenuModel(
          name: l.S.current.pharmacyPos,
          navigationPath: 'pharmacy-pos',
        ),
        SidebarSubmenuModel(
          // name :"Landlord Management"
          name: l.S.current.landLordManagement,
          navigationPath: 'landlord-management',
        ),
        SidebarSubmenuModel(
          name: "Grocery",
          navigationPath: 'grocery-admin',
        ),
      ],
    ),
    SidebarItemModel(
