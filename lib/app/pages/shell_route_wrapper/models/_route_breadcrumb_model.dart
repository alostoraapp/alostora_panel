...
Map<String, RouteBreadcrumbModel> get routerParam {
  return {
    ...
    '/dashboard/store-analytics': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'Store Analytics',
    ),
    '/dashboard/delivery': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'Delivery',
    ),
    '/dashboard/lms-management': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'LMS Management',
    ),
    '/dashboard/school-management': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'School Management',
    ),
    ...
    '/dashboard/pharmacy-pos': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'Pharmacy POS',
    ),
    '/dashboard/landlord-management': RouteBreadcrumbModel(
      //title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'Landlord Management',
    ),
    '/dashboard/grocery-admin': RouteBreadcrumbModel(
      // title: 'Dashboard',
      title: l.S.current.dashboard,
      parentRoute: 'Dashboard',
      childRoute: 'Grocery',
