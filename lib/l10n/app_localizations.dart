...
abstract class AppLocalizations {
  ...
  /// No description provided for @deleteTvChannel.
  ///
  /// In en, this message translates to:
  /// **'Delete TV Channel'**
  String get deleteTvChannel;

  /// No description provided for @deleteTvChannelConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this TV channel?'**
  String get deleteTvChannelConfirmation;

  /// No description provided for @deleteCommentator.
  ///
  /// In en, this message translates to:
  /// **'Delete Commentator'**
  String get deleteCommentator;

  /// No description provided for @deleteCommentatorConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this commentator?'**
  String get deleteCommentatorConfirmation;
}
