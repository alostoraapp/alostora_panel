...
import '../../domain/usecases/search_commentators_usecase.dart';

class CommentatorSearchDropdown extends StatefulWidget {
  final CommentatorEntity? initialSelection;
  final ValueChanged<CommentatorEntity?> onSelected;

  const CommentatorSearchDropdown({
    super.key,
  ...
  @override
  State<CommentatorSearchDropdown> createState() =>
      _CommentatorSearchDropdownState();
}

class _CommentatorSearchDropdownState extends State<CommentatorSearchDropdown> {
  final TextEditingController _controller = TextEditingController();
  final FocusNode _focusNode = FocusNode();
  final ScrollController _scrollController = ScrollController();
  final LayerLink _layerLink = LayerLink();
  final SearchCommentatorsUseCase _searchCommentatorsUseCase = sl();

  OverlayEntry? _overlayEntry;
  List<CommentatorEntity> _options = [];
  ...
  final String _tapRegionGroupId = "CommentatorSearchGroup";
  ...
  Future<void> _loadCommentators() async {
    ...
    final result = await _searchCommentatorsUseCase(
        SearchCommentatorsParams(query: _lastQuery, page: _page));
  ...
  Widget _buildListView() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final commentator = _options[index];
        return ListTile(
          ...
          title: Text(commentator.name),
          onTap: () {
            _controller.text = commentator.name;
            widget.onSelected(commentator);
            _hideOverlay();
            _focusNode.unfocus();
          },
        );
      ...
      child: TapRegion(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            labelText:
                S.of(context).commentators, // Reusing commentators string
